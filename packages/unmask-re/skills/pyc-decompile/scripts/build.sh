#!/usr/bin/env bash
# Vendor decompyle3 into runtime/site (offline, self-contained, portable).
#
...
#
# Build-time only (needs uv + network). Re-run to refresh. Commit runtime/site if
...
rm -rf "$RT/site"
echo "vendoring decompyle3 into runtime/site (pure-python)..."
